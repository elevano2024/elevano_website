...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <div className="bg-gradient-to-br from-primary-900 via-primary-800 to-primary-900 text-white py-32">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-brand text-white py-3 px-6 rounded-lg hover:bg-brand-dark transition-colors duration-300"
              >
                Send Message
              </button>
            </form>
